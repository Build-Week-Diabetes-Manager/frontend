             ...
             <Col>
                <Nav className="flex-column">
                    <div className="icon-container">
                        ...
                        <button className='icon-tab' onClick={() => setHome(true)}><img className="icon" src={ home ? require('../img/dashboardIcons/homeIcon-active.svg'): require('../img/dashboardIcons/homeIcon1.svg')} alt="Food Nutrition finder"/></button>
                       
                      
                        <button className='icon-tab' onClick={() => setHome(false)}><img className="icon" src={ home ? require('../img/dashboardIcons/graphIcon.svg'): require('../img/dashboardIcons/graphIcon-active.svg')} alt="Icon for Blood Glucose graphs"/></button>
